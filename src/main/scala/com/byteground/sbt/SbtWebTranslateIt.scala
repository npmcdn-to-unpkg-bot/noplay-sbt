...
object SbtWebTranslateIt
  ...
  override lazy val requires = SbtWeb
  ...
  lazy val unscopedProjectSettings: Seq[Setting[_]] = Seq(
    webTranslateItMasterFiles := {
      (Keys.sources.value ** (webTranslateItMasterIncludeFilter.value -- webTranslateItMasterExcludeFilter.value)).get
    },
    webTranslateItMasterMergedFiles := {
      ...
      val sourceDirs = sourceDirectories.value :+ remoteDir
    ...
    webTranslateItTranslatedLocalDirectory := sourceManaged.value / "webtranslateit",
  ...
  override lazy val projectSettings = Seq(
    ...
    webTranslateItMasterRemoteDirectory := target.value / "webtranslateit" / "remote" / "master",
    ...
    webTranslateItMasterMergedDirectory := target.value / "webtranslateit" / "merged" / "master",
    webTranslateItMasterFilesMergeStrategy := JsonMergeStrategy,
    webTranslateItTranslatedRemoteDirectory := target.value / "webtranslateit" / "remote" / "translated",
