 ...
 */
package io.noplay.sbt.web.alphard

import com.typesafe.sbt.web.Import.WebKeys._
import com.typesafe.sbt.web.Import._
import io.noplay.sbt.web.jquery.SbtJquery
import io.noplay.sbt.web.q.SbtQ
import io.noplay.sbt.web.require.SbtRequire
import SbtRequire.autoImport._
import io.noplay.sbt.web.angular.SbtAngular
...
object SbtAlphardWeb
  ...
  object autoImport {
    ...
    private def alphardWebPath(name: String, path: Option[String]): Def.Setting[_] =
      requireMainConfigPaths += name -> RequirePath(s"/${webModulesLib.value}/$Name/${path.getOrElse(name)}")
  }
