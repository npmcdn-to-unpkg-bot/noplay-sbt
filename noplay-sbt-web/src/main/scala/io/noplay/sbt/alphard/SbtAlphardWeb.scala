...
object SbtAlphardWeb
  ...
  object autoImport {
    val webUtilName = settingKey[String]("Alphard Web name")
    val webUtilVersion = settingKey[String]("Alphard Web version")
    val webUtilModule = settingKey[ModuleID]("Alphard Web module")
